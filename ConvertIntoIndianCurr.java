...
public class ConvertIntoIndianCurr {

    public static String ConvertIntoIndianCurr(double num) {
        ...
        for (String s : str) {
            RupeesBuilder.append(s).append(" ");
        }
        String Rupees = RupeesBuilder.toString().trim();
    ...
    public static void main(String[] args) {
        ...
        String result = ConvertIntoIndianCurr(number);
